...
from yolof_mask.configs.yolof.coco_schedule import lr_multiplier_3x as lr_multiplier
from yolof_mask.configs.yolof.coco_dataloader import dataloader
from yolof_mask.configs.yolof_mask.yolof_mask_r_50_se import model

dataloader.train.mapper.use_instance_mask = True
dataloader.train.total_batch_size = 16

train['output_dir'] = "./output_yolof_mask_r_50_se_3x"
